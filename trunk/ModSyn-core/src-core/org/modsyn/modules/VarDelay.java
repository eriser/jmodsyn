...
/**
 * Delay with sub-sample accuracy and variable delay time. Use this for better
 * precision and effects needing variable delay time (chorus, flanger etc).
 * 
 * @author DU1381
 * 
 */
public class VarDelay implements SignalInsert {
    ...
    /**
     * This input controls the delay feedback. 0.0f = no feedback, 1.0f is 100%
     * feedback.
     */
     ...
     * @param feedback
     *            defines the feedback (0f=no feedback, 1f=100%, -0.5f=50% with
     *            reversed phase)
     */
